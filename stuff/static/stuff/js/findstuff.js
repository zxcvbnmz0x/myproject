...
$(function()
{
    ...
    createHeaderhander( "searchstuff",parmeters);
...
function showstufflist(stuff)
{
    ...
    for(key in  stuff)
    {
        ...
        thisstuff['stuffid'] = stuff[key].stuffid;
        thisstuff['stuffname'] = stuff[key].stuffname;
        thisstuff['batchno'] = stuff[key].batchno;
        thisstuff['amount'] = stuff[key].amount+basicUnit;
...
function clickfunction()
{
    ...
    $('.mousecover').click(function(e){
        ...
        window.open("./stuffquery?autoid="+$(this).attr('id')+"&stuffid="+stuffid+"&batchno="+batchno);
    });
}
